...
export default function TopBar() {
  ...
  return (
    <div>
        <div className="rounded-t-xl bg-green-600 w-screem h-8" style={{webkitAppRegion:"drag"}}></div>
        <div className="absolute top-0.5 left-2 text-white font-bold text-xl">GCBM</div>
